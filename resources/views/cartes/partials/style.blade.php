...
<style>
    ...
    * {
    ...
    .ucao-fond-recto {
        ...
        background: linear-gradient(180deg, #e6cd7a 0%, #e6cd7a 10%, #e5e0de 40%, #e5e0de 46%, #e3f4fc 54%, #e3f4fc 73%, #a9d9f2 79%, #1d8fd6 90%, #1d8fd6 100%);
    }
