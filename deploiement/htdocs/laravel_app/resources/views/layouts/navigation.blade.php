            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center gap-3">
                    <a href="{{ route('eleves.index') }}" class="flex items-center gap-3">
                        <span class="flex h-10 w-10 items-center justify-center rounded-full bg-white p-0.5 shadow">
                            <img src="{{ asset(config('ecole.logo')) }}" alt="Logo {{ config('ecole.sigle') }}" class="h-full w-full rounded-full object-cover">
                        </span>
                        <span class="text-white font-serif text-lg tracking-wide hidden sm:inline">{{ config('ecole.sigle') }} — Cartes Scolaires</span>
                    </a>
                </div>
